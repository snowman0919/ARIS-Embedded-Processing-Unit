...
| LiDAR-first localization | `aris_localization`, Gazebo `/scan_cloud`, moving Gazebo pose-sync localization smoke, V2A known-map localization scaffold | Real Unitree/NDT/EKF work remains |
...
| V2 | Gazebo gpu_lidar `/scan_cloud`, moving Gazebo pose-sync localization smoke, deterministic LiDAR surrogate, V2A known-map localization scaffold | Gazebo physics-owned motion, Unitree L2 driver, production NDT/EKF, GPS/camera correction, real map generation | Gazebo/real drift and relocalization metrics |
