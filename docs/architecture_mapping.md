...
| LiDAR-first localization | `aris_localization`, Gazebo `/scan_cloud`, moving Gazebo pose-sync/drift-recovery smokes, V2A known-map localization scaffold | Real Unitree/NDT/EKF work remains |
